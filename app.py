...
if not OPENAI_API_KEY:
    raise ValueError("OPENAI_API_KEY not found. Check your token.env file.")
if not HUGGINGFACE_API_TOKEN:
    raise ValueError("HUGGINGFACE_API_TOKEN not found. Check your token.env file.")
...
def generate_story_from_text(scenario: str) -> str:
    prompt_template: str = """
    You are a creative storyteller with a special ability to turn simple scenes into lively, memorable tales. 
    Write a vivid, engaging micro-story that captures the provided context and can be visualized easily. 
    Keep your response concise and ensure the story does not exceed 50 words.
